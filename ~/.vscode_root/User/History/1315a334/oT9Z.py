...
def find_model_path():
    ...
    for base_path in POSSIBLE_PATHS:
        calibrated = os.path.join(base_path, "exploit_model_v2_calibrated.joblib")
        base = os.path.join(base_path, "exploit_model_v2.joblib")
        feat = os.path.join(base_path, "featurizer_v2.joblib")
...
if MODEL_PATH and FEAT_PATH:
    try:
        ...
        MODEL_CALIBRATED = MODEL_NAME.endswith("_calibrated.joblib")
