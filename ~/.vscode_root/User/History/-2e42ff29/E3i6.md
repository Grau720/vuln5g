...
# Suricata 
desde el host: curl "http://localhost:5000/api/v1/rules/suricata/top-risk?deploy=true" -> docker restart vulndb_suricata para levantar suricata con nuevas reglas